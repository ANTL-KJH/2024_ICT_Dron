...
class class_Drone_Controller_Switch:
    ...
    def runSwitch(self):
        while True:
            ...
            self.info.switch2 = True if GPIO.input(self.switch2_pin) == GPIO.HIGH else False
            self.info.switch3 = True if GPIO.input(self.switch3_pin) == GPIO.HIGH else False
            self.info.switch4 = True if GPIO.input(self.switch4_pin) == GPIO.HIGH else False
            time.sleep(0.05)
